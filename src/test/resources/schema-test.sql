...
-- 先删除所有表（子表在前，父表在后，避免外键约束冲突）
DROP TABLE IF EXISTS plan_version_log;
DROP TABLE IF EXISTS plan_school;
DROP TABLE IF EXISTS voluntary_plan;
DROP TABLE IF EXISTS user_voluntary;
DROP TABLE IF EXISTS `user`;
DROP TABLE IF EXISTS major_score;
DROP TABLE IF EXISTS major_info;
DROP TABLE IF EXISTS sc_li_score;
DROP TABLE IF EXISTS school_info_detail;
